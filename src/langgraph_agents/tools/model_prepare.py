    ...
    try:
        ...
        async with session.get(
            ...
            if quote:
                ...
                return {"quote": "Работа не волк. Никто не волк. Только волк - волк.", "author": "Джейсон Стетхем"}
...
async def should_continue(state: AgentState) -> str:
    ...
    if isinstance(last_message, AIMesssage) and last_message.tool_calls:
        return "continue"
